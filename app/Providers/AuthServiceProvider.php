...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Gate::define('order-view', function($customer, $order) {
            // KEMUDIAN DI CEK, JIKA CUSTOMER ID SAMA DENGAN CUSTOMER_ID YANG ADA PADA TABEL ORDER
            // MAKAN RETURN NYA TRUE
            // GATE INI HANYA AKAN ME-RETURN SEBAGAI TANDA DIIZINKAN ATAU TIDAK
