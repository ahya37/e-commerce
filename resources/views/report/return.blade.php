...
<script>
    {{-- ketika pertama kali di load, maka tgl di set ke tgl pertama dan terakhir pada bula saat ini --}}
    $(document).ready(function() {
        let start = moment().startOf('month')
        let end = moment().endOf('month')

        // kemudian tombol export pdf di set url nya berdasarkan tgl tersebut
        $('#exportpdf').attr('href','/administrator/reports/order/pdf/' + start.format('YYYY-MM-DD') + '+' + end.format('YYYY-MM-DD'))

        // inisisasi datarangepicker
