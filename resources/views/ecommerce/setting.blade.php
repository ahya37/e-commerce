...
<script>
    ...
    $(document).ready(function() {
        // MAKA KITA MENGAMBIL FUNGSI LOADCITY() DAN LOADDISTRICT()
            ...
            $.ajax({
                ...
                success: function(html){
                    ...
                    $.each(html.data, function(key, item) {
                        ...
                        // KITA TAMPUNG VALUE CITY SAAT INI
                        let city_selected = {{ $customer->district->city_id }};
                        // KEMUDIAN DICEK, JIKA CITY_SELECTED SAMA DENGAN ID CITY YANG DI LOOPING MAKA 'SELECTED' AKAN DI APPEND KE OPTION
                        let selected = type == 'bySelect' && city_selected == item.id ? 'selected' : '';
                        // KEMUDIAN KITA MASUKAN VALUE SELECTED DI ATAS KE DALAM TAG OPTION
