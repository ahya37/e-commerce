...
<script>
    ...
    $('#province_id').on('change', function() {
        // maka akan melakukan request ke /API/CITY
        ...
        $.ajax({
            ...
            success: function(html){
                // setelah diterima , selectbox dengan id city_id di kosongkan
                $('#city_id').empty()
                // kemudia append data baru yang didapatkan dari hasil request via ajax
